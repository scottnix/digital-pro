...
function digital_scripts_styles() {
  ...
  // scott testing - add testing file for variations.
  wp_enqueue_style( 'testing-css', get_stylesheet_directory_uri() . '/testing.css', array(), CHILD_THEME_VERSION );
...
function digital_entry_meta_header( $post_info ) {
  ...
  // scott - remove post_author info, since only 1 poster currently
...
// scott remove front page widgets, third section temporarily.
/*genesis_register_sidebar( array(
  'id'          => 'front-page-3',
